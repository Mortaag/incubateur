...
$bd->exec("INSERT INTO `Lieux` ( `Adresse`, `CodePostal`, `Ville`, `Pays`) VALUES (" . $bd->quote($_POST["Adresse"]) . ", " . $bd->quote($_POST["CodePostal"]) . ", " . $bd->quote($_POST["Ville"]) . ", " . $bd->quote($_POST["Pays"]) . " ); ");
