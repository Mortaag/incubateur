...
$bd->exec("INSERT INTO `Lieux` (`idUtilisateur`, `Adresse`, `CodePostal`, `Ville`, `Pays`) VALUES (" . $_SESSION["idUtilisateur"] ."," . $bd->quote($_POST["Adresse"]) . ", " . $bd->quote($_POST["CodePostal"]) . ", " . $bd->quote($_POST["Ville"]) . ", " . $bd->quote($_POST["Pays"]) . " ); ");
