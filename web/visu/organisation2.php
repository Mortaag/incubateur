...
$bd->exec("INSERT INTO `Dates` ( `idEvenement`, `idLieu`, `Date`, `Prix`) VALUES (" . $idEvenement . "," . $idLieu . "," . $bd->quote($_POST["Date"]) . ", " . $bd->quote($_POST["Prix"]) . " );");
// echo "INSERT INTO `Dates` ( `idEvenement`, `idLieu`, `Date`, `Prix`) VALUES (" . $idEvenement . "," . $idLieu . "," . $bd->quote($_POST["Date"]) . ", " . $bd->quote($_POST["Prix"]) . " ); ";
